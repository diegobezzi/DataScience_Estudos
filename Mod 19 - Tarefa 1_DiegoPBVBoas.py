...
def main():
    ...
    # SIDEBAR
    image = Image.open(fp='C:\\Users\\User\\Desktop\\Anaconda Projects\\Modulo 19\\img\\Bank-Branding.jpg')
    st.sidebar.image(image=image)

    # TÍTULO
    st.markdown('''
    <div style="text-align:center">
        <a href="https://github.com/diegobezzi">
            <img src="https://raw.githubusercontent.com/diegobezzi/DataScience_Estudos/main/ebac-course-utils/media/logo/ebac_logo-data_science.png" alt="ebac_logo-data_science" width=100%>
        </a>
    </div> 
    ...
    **Data:** 21 de maio de 2024.
    ...
    bank_raw = load_data(
        file_data='C:\\Users\\User\\Desktop\\Anaconda Projects\\Modulo 19\\data\\input\\bank-additional-full.csv', sep=';')
    bank = bank_raw.copy()
